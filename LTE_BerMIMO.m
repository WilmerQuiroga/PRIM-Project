...
while numErrs < 4000 && numBits < 200e6
...
EbNo=SNRdB -10*log10(k);
berTheory = berfading(EbNo, 'qam', 4, 2);
...
grid
legend('Measurements BER 16-QAM MIMO', 'Theoretical 2nd-Order Diversity')
xlabel('SNR (dB)')
